...
if (isset($_SERVER['HTTP_X_FORWARDED_FOR'])) {
   ...
   $FTGvisitor = DoStripSlashes( $_POST['Visitor-type'] );
   $FTGname = DoStripSlashes( $_POST['First_Name'] );
   $FTGemail = DoStripSlashes( $_POST['Email'] );
   $FTGmobile = DoStripSlashes( $_POST['Mobile_Number'] );
   $FTGcity = DoStripSlashes( $_POST['City'] );
   $FTGmessage = DoStripSlashes( $_POST['Message'] );
   $FTGkw = DoStripSlashes($_POST['kw']);
   $FTGsubmit = DoStripSlashes($_POST['myButton']);
   ...
   if ($validationFailed === true) {
    ...
    $errorPage = str_replace('<!--FIELDVALUE:visitor-->', $FTGvisitor, $errorPage);
    ...
    $errorPage = str_replace('<!--ERRORMSG:name-->', $FTGErrorMessage['First_Name'], $errorPage);
    $errorPage = str_replace('<!--ERRORMSG:email-->', $FTGErrorMessage['Email'], $errorPage);
    $errorPage = str_replace('<!--ERRORMSG:mobile-->', $FTGErrorMessage['Mobile_Number'], $errorPage);
   ...
   if ( $validationFailed === false ) {
    ...
    $subject = "Google Adwords Enquiry from Fluencepharma"; 
    $message = "<html>\n"
    . "<head>\n"
    . "<title></title>\n"
    . "</head>\n"
    ...
    . "Congratulations! An Enquiry has been submitted from your Campaign on <a href=\"https://www.fluencepharma.in\" target=\"_blank\">fluencepharma.in</a> with the following information:<br/><br/>\n"
    . "<b>Visitor as :</b> $FTGvisitor<br />\n"
    . "<b>Name :</b> $FTGname<br />\n"
    . "<b>Email :</b> $FTGemail<br />\n"
    . "<b>Mobile :</b> $FTGmobile<br />\n"
    . "<b>City :</b> $FTGcity<br />\n"
    . "<b>Message :</b> " . nl2br( $FTGmessage ) . "<br /><br/>\n"
...
$url = 'https://script.google.com/macros/s/AKfycbzN8f4pm7lv74RMI9JeZWBRL1n-44G1vlJqwDlzdgkuzBEYQDH7KZLDaqu9ZPA8avc/exec';

$ch = curl_init();

$post_data = array('Visitor-type'=>$_POST['Visitor-type'],
