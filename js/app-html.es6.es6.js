...
(function ($) {
	...
	THEME.initialization = {
			...
			let WishlistPage = {
				...
				_handlers: function (that) {
					...
					$(document).on('click', '.js-remove-wishlist', function (e) {
						let $product = $(this).closest('.prd, .prd-block_info'),
		...
		promoPopup(modal){
			...
			!function(t){var e={};!function(){var o,n=t.requestAnimationFrame||t.webkitRequestAnimationFrame||t.mozRequestAnimationFrame||t.oRequestAnimationFrame||t.msRequestAnimationFrame||function(e){t.setTimeout(e,1e3/60)},i={particleCount:50,angle:90,spread:45,startVelocity:45,decay:.9,ticks:200,x:.5,y:.5,zIndex:100,colors:["#26ccff","#a25afd","#ff5e7e","#88ff5a","#fcff42","#ffa62d","#ff36ff"]};function r(){}function l(t,e,o){return n=t&&null!=t[e]?t[e]:i[e],(r=o)?r(n):n;var n,r}function a(t){return parseInt(t,16)}function c(t){t.width=document.documentElement.clientWidth,t.height=document.documentElement.clientHeight}function s(t){var e,o,n=t.angle*(Math.PI/180),i=t.spread*(Math.PI/180);return{x:t.x,y:t.y,wobble:10*Math.random(),velocity:.5*t.startVelocity+Math.random()*t.startVelocity,angle2D:-n+(.5*i-Math.random()*i),tiltAngle:Math.random()*Math.PI,color:(e=t.color,o=String(e).replace(/[^0-9a-f]/gi,""),o.length<6&&(o=o[0]+o[0]+o[1]+o[1]+o[2]+o[2]),{r:a(o.substring(0,2)),g:a(o.substring(2,4)),b:a(o.substring(4,6))}),tick:0,totalTicks:t.ticks,decay:t.decay,random:Math.random()+5,tiltSin:0,tiltCos:0,wobbleX:0,wobbleY:0}}function u(o,i,l){var a=i.slice(),s=o.getContext("2d"),u=o.width,d=o.height;function m(){u=d=null}var f,h=(f=function(e){n(function i(){u||d||(c(o),u=o.width,d=o.height),s.clearRect(0,0,u,d),(a=a.filter(function(t){return function(t,e){e.x+=Math.cos(e.angle2D)*e.velocity,e.y+=Math.sin(e.angle2D)*e.velocity+3,e.wobble+=.1,e.velocity*=e.decay,e.tiltAngle+=.1,e.tiltSin=Math.sin(e.tiltAngle),e.tiltCos=Math.cos(e.tiltAngle),e.random=Math.random()+5,e.wobbleX=e.x+10*Math.cos(e.wobble),e.wobbleY=e.y+10*Math.sin(e.wobble);var o=e.tick++/e.totalTicks,n=e.x+e.random*e.tiltCos,i=e.y+e.random*e.tiltSin,r=e.wobbleX+e.random*e.tiltCos,l=e.wobbleY+e.random*e.tiltSin;return t.fillStyle="rgba("+e.color.r+", "+e.color.g+", "+e.color.b+", "+(1-o)+")",t.beginPath(),t.moveTo(Math.floor(e.x),Math.floor(e.y)),t.lineTo(Math.floor(e.wobbleX),Math.floor(i)),t.lineTo(Math.floor(r),Math.floor(l)),t.lineTo(Math.floor(n),Math.floor(e.wobbleY)),t.closePath(),t.fill(),e.tick<e.totalTicks}(s,t)})).length?n(i):(t.removeEventListener("resize",m),l(),e())})},e.exports.Promise?new e.exports.Promise(f):(f(r),null));return t.addEventListener("resize",m,!1),{addFettis:function(t){return a=a.concat(t),h},canvas:o,promise:h}}e.exports=function(t){for(var e,n,i,r=l(t,"particleCount",Math.floor),a=l(t,"angle",Number),d=l(t,"spread",Number),m=l(t,"startVelocity",Number),f=l(t,"decay",Number),h=l(t,"colors"),b=l(t,"ticks",Number),y=l(t,"zIndex",Number),g=((e=l(t,"origin",Object)).x=l(e,"x",Number),e.y=l(e,"y",Number),e),M=r,p=[],x=o?o.canvas:(n=y,c(i=document.createElement("canvas")),i.style.position="fixed",i.style.top="0px",i.style.left="0px",i.style.pointerEvents="none",i.style.zIndex=n,i),v=x.width*g.x,w=x.height*g.y;M--;)p.push(s({x:v,y:w,angle:a,spread:d,startVelocity:m,color:h[M%h.length],ticks:b,decay:f}));return o?o.addFettis(p):(document.body.appendChild(x),(o=u(x,p,function(){o=null,document.body.removeChild(x)})).promise)},e.exports.Promise=t.Promise||null}(),t.confetti=e.exports}(window);
				...
				setTimeout(function () {
					$.fancybox.open([{
						...
						afterShow: function afterShow() {
							let effect = $promoPopup.attr('data-effect');
							if (effect == 'confetti') {
								let colors = ['#f0771a', '#ffffff', '#a83ae5'];
								for (var i = 0; i < 3; i++) {
									setTimeout(function () {
										confetti({
											particleCount: 100,
		...
		quickView() {
			THEME.quickView = {
				init(options) {
					...
					let $mainCarousel = $('.js-product-main-carousel-qw'),
	...
	THEME.catalog = {
		...
		loadMoreAjax(button){
			function updateCircleLoader($button) {
				let start = $button.data('loaded') * 100 / $button.data('total'),
		...
		productTabs() {
			$('.js-circle-loader').on('click', function (e) {
				...
				$.getJSON($this.attr('href'), function (data) {
					...
					let start = $this.data('loaded') * 100 / $this.data('total'),
			...
			$('[data-grid-tab-title]').on('click', function (e) {
				...
				let $loader = $this.closest('.holder').find('.js-circle-loader'),
