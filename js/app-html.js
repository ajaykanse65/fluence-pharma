...
(function ($) {
 ...
 $(document).ready(function(){ 
	var a= '.sidebar__sub-list li a.fluence';
	
	 $(".sidebar__sub-list li a.fluence").on("click", function() {
			var a_link = $(this).attr("href");


			//$(this).addClass('active').parents("li").siblings().children().removeClass('active');
		  $(a_link).addClass( "product-block" );  
		});
		if(window.location.hash) {

			 var a_link = $(location).attr('hash');
			 $(a_link).addClass( "product-block" );
		}
		...
		$(a).each(function() 
		{
			...
			var accor="ul li .js-menu-accordion";
			if (this.href == window.location || this.href == document.location.protocol + "//" + window.location.hostname + window.location.pathname)
			{
				
				$(this).addClass('active').siblings().removeClass('active');
				 $(this).parents().prev("div").addClass("active").next('ul').slideToggle();;
   ...
   function add_quotes(){
    ...
    var searchValue =  document.querySelector(".search-input2").value;
    if(searchValue!= ''){
    console.log("before value", document.querySelector(".search-input2").value);
    
    searchValue = "\""+ document.querySelector(".search-input2").value +  "\""; 

    console.log("search value", searchValue);

    document.querySelector(".search-input2").value = searchValue;
    return true;
      }else{
    searchValue =  document.querySelector(".search-input1").value;

    console.log("before value", document.querySelector(".search-input1").value);
    
    searchValue = "\""+ document.querySelector(".search-input1").value +  "\""; 

    console.log("search value", searchValue);

    document.querySelector(".search-input1").value = searchValue;
    return true;
   }
   }